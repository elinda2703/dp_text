...
Rook and Queen contiguity matrices dominate in spatial statistics. They are the only valid choice for regionalization methods and are the default for spatial autocorrelation metrics. Bishop is rarely used on its own, but sometimes its used for hybrid weights. Beyond immediate neigbours, contiguty can be expnaded to higer order contiguity weighs (neigbours of neigbours), often used in spatial data modelling.
