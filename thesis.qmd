...
Another related phenomena leading to bias in spatial data analysis is the Modifiable Area Unit Problem (MAUP). Established by @gehlke1934 and further described in @openshaw1983. It concerns the out

### Specification of weight matrix

Weight matrix choice is pretty well researched in literature.

It has been mostly studied of spatial autocorrelation and spatial autoregressive models.

@lesage2010 refer to to the fact that misspecification of weight matrix can severly impact the estimates ans inferences as "biggest myth in spatial econometrics".

### Reliability of spatial analysis in specific conditions

-testovani na divnejch datech, @westerholt_social_media, @westerholt_poisson, @westerholt_interference
